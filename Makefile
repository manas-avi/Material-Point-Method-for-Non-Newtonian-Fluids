...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Feb 6 17:33:48 2020
# Project:  poff.pro
# Template: app
...
CXXFLAGS      = -m64 -pipe -g -O3 -std=c++11 -D__MODE_DEBUG=3 -D_REENTRANT -I/usr/local/include/SDL2 -DHAVE_OPENGLES3 -DHAVE_OPENGL -g -I../external/glfw-3.1.2/include/GLFW -fopenmp $(CFLAGS) -w -O2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lSDL2 -lGL -lSDL2_image -lgomp -fopenmp -lSDL2_ttf -lfreeimage -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/poff1.0.0/ && $(COPY_FILE) --parents src/BallObstacle.hpp src/BoxObstacle.hpp src/Camera.hpp src/CameraObject.hpp src/CameraPerso.hpp src/Cube.hpp src/Cylinder.hpp src/CylinderObstacle.hpp src/DataFile.hpp src/error.hpp src/ExceptionSimu.hpp src/Grid.hpp src/Input.hpp src/mpm_conf.hpp src/Object.hpp src/Obstacle.hpp src/OpenBoxObstacle.hpp src/OutBoxObstacle.hpp src/Particule.hpp src/PlaneObstacle.hpp src/PoissonGenerator.hpp src/Scene.hpp src/sceneLoader.hpp src/Shader.hpp src/Simulation.hpp src/Skybox.hpp src/Sphere.hpp src/SphereObstacle.hpp src/Tensor.hpp src/Texture.hpp src/Times.hpp src/utils.hpp src/common.h obj/poff1.0.0/ && $(COPY_FILE) --parents src/BallObstacle.cpp src/BoxObstacle.cpp src/Camera.cpp src/CameraObject.cpp src/CameraPerso.cpp src/Cube.cpp src/Cylinder.cpp src/CylinderObstacle.cpp src/DataFile.cpp src/error.cpp src/Grid.cpp src/Input.cpp src/main.cpp src/mpm_conf.cpp src/Object.cpp src/Obstacle.cpp src/OpenBoxObstacle.cpp src/OutBoxObstacle.cpp src/Particule.cpp src/PlaneObstacle.cpp src/PoissonGenerator.cpp src/Scene.cpp src/Shader.cpp src/Simulation.cpp src/Skybox.cpp src/Sphere.cpp src/SphereObstacle.cpp src/Tensor.cpp src/Texture.cpp src/Times.cpp src/utils.cpp obj/poff1.0.0/ && (cd `dirname obj/poff1.0.0` && $(TAR) poff1.0.0.tar poff1.0.0 && $(COMPRESS) poff1.0.0.tar) && $(MOVE) `dirname obj/poff1.0.0`/poff1.0.0.tar.gz . && $(DEL_FILE) -r obj/poff1.0.0
